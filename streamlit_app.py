...
def handle_inputs(word_doc, image_file, ht_in, wd_in, space_in, indent_in):
    try:
        ...
        with st.spinner("Processing..."):
            ...
            # postprocess.postprocess_images(imgs, spaces, indents, imgs_per_line, "./temp")
...
def main():
    ...
    with col2:
        ...
        input_form.form_submit_button(
            "Submit",
            on_click=handle_inputs,
            args=[word_doc, image_file, ht_in, wd_in, space_in, indent_in],
        )
