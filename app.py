...
def root():
    ...
    Returns:
        file: The pdf of file of the generated handwritten document.
    """
...
def handle_post(request, id):
    ...
    Args:
        request (HTTP.POST): The post request from the client containing handwritting samples
            and document as a string.
